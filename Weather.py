...
def getWeather():
    try:
        ...
        if "sunny" in description.lower() or 'Clear skies' in description.lower() or 'Sunny intervals' in description.lower():
            Logo_image = PhotoImage(file="imgWeather/logo/sun.png")
        elif 'windy' in description.lower() or 'breezy' in description.lower() or 'gale' in description.lower():
            Logo_image = PhotoImage(file="imgWeather/logo/windy.png")
            ...
            Logo_image = PhotoImage(file="imgWeather/logo/snow.png")
            ...
            Logo_image = PhotoImage(file="imgWeather/logo/rain.png")
            ...
            Logo_image = PhotoImage(file="imgWeather/logo/clouds.png")
            ...
            Logo_image = PhotoImage(file="imgWeather/logo/logo.png")
        else:
            Logo_image = PhotoImage(file="imgWeather/logo/sun.png")
...
# search box
Search_image = PhotoImage(file="imgWeather/1search.png")
...
Search_icon = PhotoImage(file="imgWeather/search_icon.png")
...
# Bottom box
Frame_image = PhotoImage(file="imgWeather/box.png")
